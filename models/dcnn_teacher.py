...
class dgcnn_cls_teacher(nn.Module):
    def __init__(self, args, output_channels=40):
        super(dgcnn_cls_teacher, self).__init__()
        self.args = args
        self.k = args.k
        self.k_relations = 12
        self.k_probs = 12
...
class dgcnn_partseg_teacher(nn.Module):
    def __init__(self, args, seg_num_all):
        super(dgcnn_partseg_teacher, self).__init__()
        self.args = args
    ...
    def forward(self, x, affordance=''):
        ...
        l = torch.rand(batch_size, 16, 1).cuda()
...
class dgcnn_semseg_s3dis_teacher(nn.Module):
    def __init__(self, args):
        super(dgcnn_semseg_s3dis_teacher, self).__init__()
        self.args = args
        self.k = args.k
